...
public class LamettPsiParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // KW_TYPE | KW_ISET | KW_SET | KW_INTERVAL | NUMBER | KW_F | KW_PARTIAL | KW_COE | KW_HCOM | KW_SUB | KW_INS | KW_OUTS
  ...
  public static boolean inegExpr(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, KW_INEG)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, KW_INEG);
    r = r && atomExpr(b, l + 1);
    exit_section_(b, m, INEG_EXPR, r);
    return r;
  }
  ...
  // tupleAtom | partialAtom | inegExpr | literal
